...
contract EnsoFlashloanShortcutsTest is Test, ERC721Holder, ERC1155Holder {
    ...
    function testMorphoFlashloan() public {
        ...
        IWETH token = IWETH(address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2));
        ...
        shortcuts.flashLoan(FlashloanProtocols.Morpho, user_bob, morphoData, commands, state);
    }
    ...
    function testMorphoFlashloan_excess() public {
        ...
        shortcuts.flashLoan(FlashloanProtocols.Morpho, receiver, morphoData, commands, state);
    ...
    function testEulerFlashLoan() public {
        ...
        // eWETH-2 Euler vault
        address eulerVault = address(0xD8b27CF359b7D15710a5BE299AF6e7Bf904984C2);
        ...
        shortcuts.flashLoan(FlashloanProtocols.Euler, user_bob, eulerData, commands, state);
    }
    ...
    function testEulerFlashLoan_excess() public {
        ...
        uint256 balanceBefore = token.balanceOf(receiver);
        shortcuts.flashLoan(FlashloanProtocols.Euler, receiver, eulerData, commands, state);
    ...
    function testBalancerV2Flashloan() public {
        ...
        bytes memory balancerV2Data = abi.encode(balancerV2Vault, tokens, amounts);

        shortcuts.flashLoan(FlashloanProtocols.BalancerV2, user_bob, balancerV2Data, commands, state);
    }
    ...
    function testBalancerV2Flashloan_excess() public {
        ...
        shortcuts.flashLoan(FlashloanProtocols.BalancerV2, receiver, balancerV2Data, commands, state);
    ...
    function testAaveV3FlashLoan() public {
        ...
        IAaveV3Pool aaveV3Pool = IAaveV3Pool(address(0x87870Bca3F3fD6335C3F4ce8392D69350B4fA4E2));
        IWETH token = IWETH(address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2));
        ...
        shortcuts.flashLoan(FlashloanProtocols.AaveV3, user_bob, aaveData, commands, state);
    }
}
