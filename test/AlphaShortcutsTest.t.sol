...
contract AlphaShortcutsTest is Test {
    ...
    function test_foo_1() public {
        ...
        vm.prank(s_deployer);
        address payable account = payable(s_accountFactory.deploy(SIGNER));
        userOp.sender = account;

        vm.prank(SIGNER);
        (bool success, bytes memory data) = account.call{ value: 1 ether }("");

        // NOTE: from `accountExpected` to itself, 1 ETH to 1 WETH, via router
        // TODO: use delegate
        // NOTE: receiver is `account`
        bytes memory shortcutCalldata =
            "";
        // NOTE: receiver is `SIGNER`
        bytes memory routerCalldata2 =
            "";
