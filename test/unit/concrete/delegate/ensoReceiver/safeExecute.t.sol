    ...
    TokenBalanceHelper
{
        ...
        whenTokenInIsNativeToken
    {
        ...
        vm.expectEmit(address(s_ensoReceiver));
        emit EnsoReceiver
            .ShortcutExecutionFailed(hex"");
        s_ensoReceiver.safeExecute(IERC20(shortcut.tokensIn[0]), shortcut.amountsIn[0], shortcut.txData);
