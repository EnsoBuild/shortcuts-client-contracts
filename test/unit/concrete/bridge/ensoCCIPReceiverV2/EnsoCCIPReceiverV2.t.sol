...
abstract contract EnsoCCIPReceiverV2_Unit_Concrete_Test is Test {
    ...
    function setUp() public virtual {
        ...
        s_ensoCcipReceiver = new EnsoCCIPReceiverV2(s_owner, address(s_ccipRouter), address(s_ensoRouter));
        vm.label(address(s_ensoCcipReceiver), "EnsoCCIPReceiverV2");
        ...
        s_tokenC = new MockERC20("Token C", "TKNC");
        vm.label(address(s_tokenC), "TKNC");
        s_tokenC.mint(s_deployer, 1000 ether);
