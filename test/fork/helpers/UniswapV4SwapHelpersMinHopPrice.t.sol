...
contract UniswapV4SwapHelpersMinHopPriceForkTest is Test {
    ...
    UniswapV4SwapHelpersMinHopPrice helper;
    UniswapV4SwapHelpers oldHelper;

    function setUp() public {
        vm.createSelectFork(vm.envString("ROBINHOOD_RPC_URL"), 16_565_000);
        helper = new UniswapV4SwapHelpersMinHopPrice(UNIVERSAL_ROUTER, PERMIT2);
    ...
    function test_minHopPriceHelper_swapSucceedsOnRobinhood() public {
