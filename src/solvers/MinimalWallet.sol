...
contract MinimalWallet is ERC721Holder, ERC1155Holder {
    ...
    function withdraw(TransferNote[] calldata notes) external isPermitted {
    ...
    function withdrawETH(uint256 amount) external isPermitted {
        _withdrawETH(amount);
    }
    ...
    function revokeApprovals(ApprovalNote[] calldata notes) external isPermitted {
